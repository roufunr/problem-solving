package leetcode.daily_challenge.may_to_july_24.build_matrix_with_conditions;

import java.util.*;

public class Solution {
    private boolean dfs(int src, List<List<Integer>> adj, Set<Integer> visited, Set<Integer> path,
